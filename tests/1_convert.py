...
eegFileList, patientList, _ = ObtainEEGFilePaths(config.trc_raw_dir, patient_index=None, file_index=None)
...
TRCtoFIF(eegFileList, fifFileList, 
         saveFIF=True, anonymize=False, removeChannels=False, 
...
# ---------- Examine channel list --> determine which to remove ----------

fifBasePath = os.path.join(BasePath, 'fif')
fifFilesToExamine,patientList, _ = ObtainEEGFilePaths(fifBasePath, patient_index=None,file_index=1)
...
#  --> fill in config.py with bad channel names, prefixes, suffixes
