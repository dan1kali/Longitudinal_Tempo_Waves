...
1. Update config.py file with desired base save path for all data/metadata!!! Recommended path is: '/path/to/this/repo/Data'
...
2. Then simply use scripts from tests/ to process data. In all scripts, simply the folder that patient 
    ...
    other:
    0.1_figures.py - generate simply figures with statistics about the data
